...
const ownerNumber = "6282268901378@s.whatsapp.net"
const dtod = "6282268901378@s.whatsapp.net"
const otod = "6282268901378@s.whatsapp.net"
// STICKER WM
...
return url.match(new RegExp(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&/=]*)/, 'gi'))
		...
		const katalog = (teks) => {
             res = kurr.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© Jeffri Botz_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             kurr.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = kurr.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/Gw9hcJZJpbz5fHgBwa2HHz', "groupName": `${NamaBot}`, "footerText": "*_© Jeffri Botz_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		...
		const reply = (teks) => {
			kurr.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jmn} - ${week} ${weton} - ${calender}`,body:"DON'T CLICK HERE",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/p/6349482305092740/6282268901378`}}})
		}
...
if(budy.includes('Jeffri Botz')){
cpref = `Hayo Ngomongin Jeffri Ganteng Yaaa Aowkowkwoo`
reply(cpref)
}
if(budy.includes('JeffTod')){
cpref = `Hayo Ngomongin Jeffri Ganteng Yaaa Aowkowkwoo`
reply(cpref)
}
           if (budy.startsWith('>')){
...
sendButMessage(from, `${JSON.stringify(me, null, 2)}`, "*_© JefXd_*", [{buttonId: 'igm', buttonText: {displayText: 'Instagram'}, type: 1},{buttonId: 'ytm', buttonText: {displayText: 'YouTube'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
}
if(isButton == 'igm'){
reply('http://instagram.com/jeffri_kusmanto')
}
if(isButton == 'ytm'){
reply('https://youtube.com/channel/UCiW0uYlQtba6tlKNWXEcqug')
}
...
└─────────────────❒`
sendButLocation(from, `${menu}`, "*_© Jeffri Botz_*", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`store`,buttonText:{displayText:'𝙎𝙩𝙤𝙧𝙚 𝙈𝙚𝙣𝙪'},type:1},{buttonId:`sc`,buttonText:{displayText:'SC'},type:1},{buttonId:`catalog`,buttonText:{displayText:'CATALOG MENU'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
...
`
sendButLocation(from, `${menu}`, "*_© Jeffri Botz_*", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`allmenu`,buttonText:{displayText:'ALL MENU'},type:1},{buttonId:`rules`,buttonText:{displayText:'RULES'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
else if(menusimpel = true){
        stod = `${sender}`
fill =`Hai Kak ${pushname}, ${tampilUcapan}
...
case 'catalog': 
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                ...
                nama = ' CATALOG MENU '
       ownerJid = "6282268901378@s.whatsapp.net"
                nomor = 1
                stod = `${sender}`
       stst = await kurr.getStatus(`${sender.split('@')[0]}@c.us`)
				stst = stst.status == 401 ? '' : stst.status
...
📥 BERMINAT ? HUBUNGI :
wa.me/6282268901378 (Owner)


*MATURSUWUN MONGGO DI LARISI*`
sendButLocation(from, `${menu}`, "*_© Jeffri Botz_*", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`menu`,buttonText:{displayText:'BACK TO MENU'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
else if(menusimpel = true){
        stod = `${sender}`
fill =`Hai Kak ${pushname}, ${tampilUcapan}
...
MY YOUTUBE
[https://youtube.com/channel/UCiW0uYlQtba6tlKNWXEcqug
   `
menu =`Jeffri Botz`
gbutsan = [
...
ʸᵒᵘᵗᵘᵇᵉ ᵒʷⁿᵉʳ:https://youtube.com/channel/UCiW0uYlQtba6tlKNWXEcqug`
sendButLocation(from, `${menu}`, "*_© Jeffri Botz_*", {jpegThumbnail:logonya,name:""}, [{buttonId:`menu`,buttonText:{displayText:'SIAP OM'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
break
case 'verify':
...
*└───────────────────*
Scan QR di atas bila menggunakan gopay`
...
"templateMessage": {
						"hydratedTemplate": {
							...
							"hydratedFooterText": `Jeffri Botz`,
							"hydratedButtons": [
								{
									"quickReplyButton": {
...
case 'chiisaihentai':
              ...
              buttonsMessage = {footerText:'✗✗✗ JefXd', imageMessage: imageMsg,
              contentText:`Subrek yt : Jeffri Botz`,buttons,headerType:4}
...
case 'blackpink':
                ...
                if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                    ...
                    getBuffer(`https://api.lolhuman.xyz/api/textprome/${command}?apikey=KurrXd&text=${ini_txt}`).then((gambar) => {
                        kurr.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `Subrek yt : Jeffri Botz`, quoted : ftrol})
                    })
                    break
                case 'pornhub':
                case 'glitch':
...
case 'neko':
       ...
       if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
        ...
        case 'hentai':
           ...
           await kurr.sendMessage(from, hentai, image, { quoted:mek,caption:'Hentaii Nih Ngab🗿' })
           } catch(e) { 
              reply(`${e}`)
           }
           break 
...
kurr.sendMessage(from, {url: `${pint[Math.floor(Math.random() * pint.length)]}`}, image, {quoted: mek, thumbnail: Buffer.alloc(0), caption: "Subscribe Jeffri Botz"})
break
case 'isbaileys': 
case 'bail': 
case 'baileys':
...
Giliran = @${tty.player1.split('@')[0]}`
 kurr.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.player1,tty.player2]}})
     ...
     kurr.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *ALERT-ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer ${NamaBot}",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./logonya.jpeg'),sourceUrl:"https://wa.me/p/6349482305092740/6282268901378"}}})
	}
    }
    }
    }
