...
const starts = async (kurr = new WAConnection()) => {
	...
	console.log(color(figlet.textSync('Jeffri Botz', {
		font: 'Standard',
	...
	kurr.browserDescription = [ 'Jeffri Botz', 'ubuntu', '3.0' ]
	...
	kurr.on('open', () => {
		success('2', 'Connected, Ketik .menu di Whatsapp..!!')
	})
...
kurr.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
   ...
   // owner
    ...
    const htod = "6282268901378@s.whatsapp.net"
...
kurr.on('group-update', async (anu) => {
    ...
    kurr.on('chat-update', async (message) => {
        ...
        ownerNumber = ["6282268901378@s.whatsapp.net","6282268901378@s.whatsapp.net",`${settings.NomorOwner}@s.whatsapp.net`]
        dtod = "6282268901378@s.whatsapp.net"
